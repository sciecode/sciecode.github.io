...
c)}};(function(){try{p=new THREE.WebGLRenderer({antialias:!0,failIfMajorPerformanceCaveat:!0})}catch(lb){console.error("Atomize \u2022 Hardware Acceleration not enabled or GPU not available."),ha=!1}if(ha&&WEBGL.isWebGLAvailable()){ha=!0;p.setSize(window.innerWidth,window.innerHeight);p.setPixelRatio(window.devicePixelRatio);p.setClearColor(132102);p.sortObjects=!1;p.shadowMap.type=THREE.PCFSoftShadowMap;p.shadowMap.enabled=!0;document.body.appendChild(p.domElement);v=new THREE.Scene;v.fog=new THREE.FogExp2(132102,
.0016);k=new THREE.PerspectiveCamera(75,window.innerWidth/window.innerHeight,1,1E4);k.position.copy(kb);I=new THREE.OrbitControls(k,p.domElement);I.enablePan=!1;I.enableZoom=!1;I.enableRotate=!1;I.update();var b=v,c=k,a=window.innerWidth,e=window.innerHeight;u=new THREE.EffectComposer(p);u.setSize(a,e);Ga=a;Ha=e;b=new THREE.RenderPass(b,c);U=new THREE.SavePass(new THREE.WebGLRenderTarget(Ga,Ha,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBFormat,stencilBuffer:!1}));L=
new THREE.ShaderPass(THREE.BlendShader,"tDiffuse1");L.uniforms.tDiffuse2.value=U.renderTarget.texture;L.uniforms.mixRatio.value=.25;a=new THREE.UnrealBloomPass(new THREE.Vector2(a,e),.2,0,.19);e=new THREE.ShaderPass(THREE.CopyShader);e.renderToScreen=!0;u.addPass(b);u.addPass(L);u.addPass(U);u.addPass(a);u.addPass(e);t=new THREE.Object3D;t.position.set(0,190,0);a=new THREE.AmbientLight(3355443,1.4);t.add(a);a=new THREE.DirectionalLight(12225419,.5);a.position.set(1,1,1);t.add(a);a=new THREE.DirectionalLight(9157300,
.3);a.position.set(1,1,-1);t.add(a);a=new THREE.PointLight(10066329,1.2,1600);a.castShadow=!0;a.shadow.camera.near=10;a.shadow.camera.far=1E3;a.shadow.bias=.04;a.shadow.mapSize.width=2048;a.shadow.mapSize.height=2048;t.add(a);a=new THREE.PlaneGeometry(4E3,4E3,10,10);e=new THREE.MeshStandardMaterial({roughness:.7,metalness:1,dithering:!0,color:1779512,emissive:0});w=new THREE.Mesh(a,e);w.rotation.x=-1.57;w.position.y=-55;w.receiveShadow=!0;Ua(p,k);Xa(k);v.add(H);v.add(t);v.add(w);eb(k,I);a=p.getContext();
e="lowp";0<a.getShaderPrecisionFormat(a.VERTEX_SHADER,a.MEDIUM_FLOAT).precision&&0<a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.MEDIUM_FLOAT).precision&&(e="mediump");0<a.getShaderPrecisionFormat(a.VERTEX_SHADER,a.HIGH_FLOAT).precision&&0<a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.HIGH_FLOAT).precision&&(e="highp");d.precision=e;requestAnimationFrame(Za)}else{console.warn("Atomize \u2022 Initialization aborted.");a=document.getElementById("video-container");e=document.createElement("VIDEO");
e.src=".assets/media/loop.mp4";e.loop=!0;e.autoplay=!0;e.muted=!0;a.appendChild(e);a=document.getElementById("intro");e=document.getElementById("st_btn");b=document.getElementById("st_notice");c=document.getElementById("st_steps");var f=document.getElementsByTagName("BODY")[0];a.classList.add("hidden");e.classList.add("hidden");b.classList.remove("hidden");c.classList.remove("hidden");f.classList.remove("hid")}})()})();